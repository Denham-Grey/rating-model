...
function AmlPreview() {
	const rows: [string, string, number, string, string][] = [
		[
			"#cf7f77",
			"color-mix(in srgb, #cf7f77 42%, transparent)",
			42,
			"Flagged · PEP",
			"96%",
		],
		[
			"#d8ab5f",
			"color-mix(in srgb, #d8ab5f 34%, transparent)",
			34,
			"High risk",
			"74%",
		],
		[
			"#7fbf95",
			"color-mix(in srgb, var(--color-text) 13%, transparent)",
			13,
			"Low risk",
			"11%",
		],
	...
	return (
		<>
			...
			<span
				...
				<span
					style={{
						...
						borderRadius: "50%",
						background:
							"conic-gradient(var(--color-accent) 0 65%, color-mix(in srgb, var(--color-text) 11%, transparent) 65% 100%)",
						display: "flex",
						alignItems: "center",
					...
					<span
						style={{
							...
							borderRadius: "50%",
							background:
								"color-mix(in srgb, var(--color-bg) 92%, var(--color-text))",
							display: "flex",
							alignItems: "center",
							justifyContent: "center",
			...
			<span
				...
				Credit officers certified, by module
			</span>
		</>
	);
}
			...
			<span
				...
				<span
					style={{
						...
						inset: 0,
						background:
							"repeating-linear-gradient(180deg, color-mix(in srgb, var(--color-text) 8%, transparent) 0 1px, transparent 1px 17px)",
					}}
				/>
				<span
					style={{
						...
						clipPath:
							"polygon(0 90%,14% 86%,28% 84%,42% 79%,57% 75%,71% 70%,85% 64%,100% 59%,100% 63%,85% 68%,71% 74%,57% 79%,42% 83%,28% 88%,14% 90%,0 94%)",
					}}
				/>
				<span
					style={{
						...
						inset: 0,
						background:
							"linear-gradient(180deg, color-mix(in srgb, var(--color-accent) 38%, transparent), transparent 88%)",
						clipPath:
							"polygon(0 82%,14% 68%,28% 74%,42% 49%,57% 57%,71% 33%,85% 28%,100% 9%,100% 100%,0 100%)",
					}}
				/>
				<span
					style={{
						...
						background: "var(--color-accent)",
						clipPath:
							"polygon(0 82%,14% 68%,28% 74%,42% 49%,57% 57%,71% 33%,85% 28%,100% 9%,100% 13%,85% 32%,71% 37%,57% 61%,42% 53%,28% 78%,14% 72%,0 86%)",
					}}
				/>
			</span>
			<span
...
const MODULES: Module[] = [
	{
		key: "rating",
		icon: "ph-gauge",
		title: "FI Credit Rating",
		description:
			"Institutional scoring, calibrated to second-tier lenders.",
		href: RATING_MODEL_URL,
		preview: <CreditRatingPreview />,
	},
	{
		key: "green",
		icon: "ph-leaf",
		title: "FI Green Rating",
		description: "The whole institution rated, and the path to A.",
		preview: <GreenRatingPreview />,
	},
	{
		key: "monitor",
		icon: "ph-pulse",
		title: "Portfolio Monitor",
		description: "NPL, CAR, SHF and PBT against covenant, daily.",
		preview: <PortfolioMonitorPreview />,
	},
	{
		key: "aml",
		icon: "ph-shield-warning",
		title: "Compliance & AML",
		description: "Sanctions, PEP and adverse media, every match scored.",
		preview: <AmlPreview />,
	},
	{
		key: "academy",
		...
		title: "Green Academy",
		description: "Four modules. Credit officers certified before drawdown.",
	...
	},
	{
		...
		description: "Borrower-level data into the quarterly investor pack.",
...
function ModuleTile({ mod }: { mod: Module }) {
		...
		<>
			<span
				...
				style={{
					...
					background:
						"linear-gradient(180deg, color-mix(in srgb, var(--color-text) 6%, transparent), color-mix(in srgb, black 20%, transparent))",
					padding: "15px 16px",
					overflow: "hidden",
				}}>
				{mod.preview}
			...
			<span
				...
				<span
					...
					<i
						className={`ph ${mod.icon}`}
						style={{ fontSize: 23, color: "var(--color-accent)" }}
					/>
				</span>
				<span
					style={{
	...
	if (comingSoon) {
		return (
			<div style={{ ...sharedStyle, opacity: 0.6, cursor: "default" }}>
				{inner}
			</div>
		);
	}
			...
			<div
				...
				<div style={{ maxWidth: "58ch", marginBottom: 40 }}>
					...
					<p
						...
						Six live systems — rating, screening, monitoring and
						reporting — in one place, for the people who use them
						daily.
					</p>
				</div>
